...
; RUN: opt < %s -pgo-loop-sink -break-crit-edges -branch-prob -S | FileCheck %s
; RUN: opt < %s -pgo-loop-sink -break-crit-edges -lazy-block-freq -S | FileCheck %s
; RUN: opt < %s -pgo-loop-sink -break-crit-edges -lazy-branch-prob -S | FileCheck %s
