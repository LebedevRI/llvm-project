...
; RUN: opt -S -simplifycfg -simplifycfg-require-and-preserve-domtree=1 -speculatively-execute-then-else-code-folding-threshold=4 -phi-node-folding-threshold=0 < %s | FileCheck %s
