...
; RUN: opt -S -simplifycfg -simplifycfg-require-and-preserve-domtree=1 -speculatively-execute-then-else-code-folding-threshold=0 -phi-node-folding-threshold=4 < %s | FileCheck %s
