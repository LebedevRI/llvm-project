...
; CHECK-LE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED:%.*]] = lshr i64 [[INTERMEDIATE_VAL1_FROZEN_BITS]], [[DOTNUMBITS]]
...
; CHECK-LE-64-NEXT:    [[TMP6:%.*]] = bitcast i16 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_EXTRACTED]] to <2 x i8>
; CHECK-LE-64-NEXT:    call void @use.v2i8(<2 x i8> [[TMP6]])
; CHECK-LE-64-NEXT:    ret void
;
...
; CHECK-LE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED:%.*]] = lshr i64 [[INTERMEDIATE_VAL1_FROZEN_BITS]], [[DOTNUMBITS]]
...
; CHECK-LE-32-NEXT:    [[TMP6:%.*]] = bitcast i16 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_EXTRACTED]] to <2 x i8>
; CHECK-LE-32-NEXT:    call void @use.v2i8(<2 x i8> [[TMP6]])
; CHECK-LE-32-NEXT:    ret void
;
...
; CHECK-BE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED:%.*]] = shl i64 [[INTERMEDIATE_VAL1_FROZEN_BITS]], [[DOTNUMBITS]]
...
; CHECK-BE-64-NEXT:    [[TMP6:%.*]] = bitcast i16 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART_EXTRACTED]] to <2 x i8>
; CHECK-BE-64-NEXT:    call void @use.v2i8(<2 x i8> [[TMP6]])
; CHECK-BE-64-NEXT:    ret void
;
...
; CHECK-BE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED:%.*]] = shl i64 [[INTERMEDIATE_VAL1_FROZEN_BITS]], [[DOTNUMBITS]]
...
; CHECK-BE-32-NEXT:    [[TMP6:%.*]] = bitcast i16 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART_EXTRACTED]] to <2 x i8>
; CHECK-BE-32-NEXT:    call void @use.v2i8(<2 x i8> [[TMP6]])
; CHECK-BE-32-NEXT:    ret void
;
  %intermediate = alloca [8 x i8], align 64
...
; CHECK-LE-64-NEXT:    [[INIT:%.*]] = load <8 x i8>, ptr [[SRC:%.*]], align 1
; CHECK-LE-64-NEXT:    [[TMP1:%.*]] = getelementptr i16, ptr null, i64 [[BYTEOFF0:%.*]]
; CHECK-LE-64-NEXT:    [[INTERMEDIATE_VAL_FROZEN:%.*]] = freeze <8 x i8> [[INIT]]
; CHECK-LE-64-NEXT:    [[INTERMEDIATE_VAL_FROZEN_BITS:%.*]] = bitcast <8 x i8> [[INTERMEDIATE_VAL_FROZEN]] to i64
; CHECK-LE-64-NEXT:    [[TMP2:%.*]] = ptrtoint ptr [[TMP1]] to i64
; CHECK-LE-64-NEXT:    [[TMP3:%.*]] = sub i64 [[TMP2]], 0
...
; CHECK-LE-64-NEXT:    [[TMP5:%.*]] = bitcast i16 [[INTERMEDIATE_VAL_FROZEN_BITS_POSITIONED_EXTRACTED]] to <2 x i8>
; CHECK-LE-64-NEXT:    call void @use.v2i8(<2 x i8> [[TMP5]])
; CHECK-LE-64-NEXT:    [[TMP6:%.*]] = getelementptr i16, ptr [[TMP1]], i64 [[BYTEOFF1:%.*]]
; CHECK-LE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN:%.*]] = freeze <8 x i8> [[INIT]]
; CHECK-LE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS:%.*]] = bitcast <8 x i8> [[INTERMEDIATE_VAL1_FROZEN]] to i64
; CHECK-LE-64-NEXT:    [[TMP7:%.*]] = ptrtoint ptr [[TMP6]] to i64
; CHECK-LE-64-NEXT:    [[TMP8:%.*]] = sub i64 [[TMP7]], 0
; CHECK-LE-64-NEXT:    [[TMP9:%.*]] = sdiv exact i64 [[TMP8]], ptrtoint (ptr getelementptr (i8, ptr null, i32 1) to i64)
; CHECK-LE-64-NEXT:    [[DOTNUMBITS2:%.*]] = mul i64 [[TMP9]], 8
; CHECK-LE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED:%.*]] = lshr i64 [[INTERMEDIATE_VAL1_FROZEN_BITS]], [[DOTNUMBITS2]]
; CHECK-LE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_EXTRACTED:%.*]] = trunc i64 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED]] to i16
; CHECK-LE-64-NEXT:    [[TMP10:%.*]] = bitcast i16 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_EXTRACTED]] to <2 x i8>
; CHECK-LE-64-NEXT:    call void @use.v2i8(<2 x i8> [[TMP10]])
; CHECK-LE-64-NEXT:    ret void
;
; CHECK-LE-32-LABEL: @two-loads-of-two-2byte-chunks-of-8byte-alloca-with-2byte-step-variable-geps(
; CHECK-LE-32-NEXT:    [[INIT:%.*]] = load <8 x i8>, ptr [[SRC:%.*]], align 1
; CHECK-LE-32-NEXT:    [[TMP1:%.*]] = getelementptr i16, ptr null, i64 [[BYTEOFF0:%.*]]
; CHECK-LE-32-NEXT:    [[INTERMEDIATE_VAL_FROZEN:%.*]] = freeze <8 x i8> [[INIT]]
; CHECK-LE-32-NEXT:    [[INTERMEDIATE_VAL_FROZEN_BITS:%.*]] = bitcast <8 x i8> [[INTERMEDIATE_VAL_FROZEN]] to i64
; CHECK-LE-32-NEXT:    [[TMP2:%.*]] = ptrtoint ptr [[TMP1]] to i64
; CHECK-LE-32-NEXT:    [[TMP3:%.*]] = sub i64 [[TMP2]], 0
...
; CHECK-LE-32-NEXT:    [[TMP5:%.*]] = bitcast i16 [[INTERMEDIATE_VAL_FROZEN_BITS_POSITIONED_EXTRACTED]] to <2 x i8>
; CHECK-LE-32-NEXT:    call void @use.v2i8(<2 x i8> [[TMP5]])
; CHECK-LE-32-NEXT:    [[TMP6:%.*]] = getelementptr i16, ptr [[TMP1]], i64 [[BYTEOFF1:%.*]]
; CHECK-LE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN:%.*]] = freeze <8 x i8> [[INIT]]
; CHECK-LE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS:%.*]] = bitcast <8 x i8> [[INTERMEDIATE_VAL1_FROZEN]] to i64
; CHECK-LE-32-NEXT:    [[TMP7:%.*]] = ptrtoint ptr [[TMP6]] to i64
; CHECK-LE-32-NEXT:    [[TMP8:%.*]] = sub i64 [[TMP7]], 0
; CHECK-LE-32-NEXT:    [[TMP9:%.*]] = sdiv exact i64 [[TMP8]], ptrtoint (ptr getelementptr (i8, ptr null, i32 1) to i64)
; CHECK-LE-32-NEXT:    [[DOTNUMBITS2:%.*]] = mul i64 [[TMP9]], 8
; CHECK-LE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED:%.*]] = lshr i64 [[INTERMEDIATE_VAL1_FROZEN_BITS]], [[DOTNUMBITS2]]
; CHECK-LE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_EXTRACTED:%.*]] = trunc i64 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED]] to i16
; CHECK-LE-32-NEXT:    [[TMP10:%.*]] = bitcast i16 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_EXTRACTED]] to <2 x i8>
; CHECK-LE-32-NEXT:    call void @use.v2i8(<2 x i8> [[TMP10]])
; CHECK-LE-32-NEXT:    ret void
;
; CHECK-BE-64-LABEL: @two-loads-of-two-2byte-chunks-of-8byte-alloca-with-2byte-step-variable-geps(
; CHECK-BE-64-NEXT:    [[INIT:%.*]] = load <8 x i8>, ptr [[SRC:%.*]], align 1
; CHECK-BE-64-NEXT:    [[TMP1:%.*]] = getelementptr i16, ptr null, i64 [[BYTEOFF0:%.*]]
; CHECK-BE-64-NEXT:    [[INTERMEDIATE_VAL_FROZEN:%.*]] = freeze <8 x i8> [[INIT]]
; CHECK-BE-64-NEXT:    [[INTERMEDIATE_VAL_FROZEN_BITS:%.*]] = bitcast <8 x i8> [[INTERMEDIATE_VAL_FROZEN]] to i64
; CHECK-BE-64-NEXT:    [[TMP2:%.*]] = ptrtoint ptr [[TMP1]] to i64
; CHECK-BE-64-NEXT:    [[TMP3:%.*]] = sub i64 [[TMP2]], 0
...
; CHECK-BE-64-NEXT:    [[TMP5:%.*]] = bitcast i16 [[INTERMEDIATE_VAL_FROZEN_BITS_POSITIONED_PART_EXTRACTED]] to <2 x i8>
; CHECK-BE-64-NEXT:    call void @use.v2i8(<2 x i8> [[TMP5]])
; CHECK-BE-64-NEXT:    [[TMP6:%.*]] = getelementptr i16, ptr [[TMP1]], i64 [[BYTEOFF1:%.*]]
; CHECK-BE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN:%.*]] = freeze <8 x i8> [[INIT]]
; CHECK-BE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS:%.*]] = bitcast <8 x i8> [[INTERMEDIATE_VAL1_FROZEN]] to i64
; CHECK-BE-64-NEXT:    [[TMP7:%.*]] = ptrtoint ptr [[TMP6]] to i64
; CHECK-BE-64-NEXT:    [[TMP8:%.*]] = sub i64 [[TMP7]], 0
; CHECK-BE-64-NEXT:    [[TMP9:%.*]] = sdiv exact i64 [[TMP8]], ptrtoint (ptr getelementptr (i8, ptr null, i32 1) to i64)
; CHECK-BE-64-NEXT:    [[DOTNUMBITS2:%.*]] = mul i64 [[TMP9]], 8
; CHECK-BE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED:%.*]] = shl i64 [[INTERMEDIATE_VAL1_FROZEN_BITS]], [[DOTNUMBITS2]]
; CHECK-BE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART:%.*]] = lshr i64 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED]], 48
; CHECK-BE-64-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART_EXTRACTED:%.*]] = trunc i64 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART]] to i16
; CHECK-BE-64-NEXT:    [[TMP10:%.*]] = bitcast i16 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART_EXTRACTED]] to <2 x i8>
; CHECK-BE-64-NEXT:    call void @use.v2i8(<2 x i8> [[TMP10]])
; CHECK-BE-64-NEXT:    ret void
;
; CHECK-BE-32-LABEL: @two-loads-of-two-2byte-chunks-of-8byte-alloca-with-2byte-step-variable-geps(
; CHECK-BE-32-NEXT:    [[INIT:%.*]] = load <8 x i8>, ptr [[SRC:%.*]], align 1
; CHECK-BE-32-NEXT:    [[TMP1:%.*]] = getelementptr i16, ptr null, i64 [[BYTEOFF0:%.*]]
; CHECK-BE-32-NEXT:    [[INTERMEDIATE_VAL_FROZEN:%.*]] = freeze <8 x i8> [[INIT]]
; CHECK-BE-32-NEXT:    [[INTERMEDIATE_VAL_FROZEN_BITS:%.*]] = bitcast <8 x i8> [[INTERMEDIATE_VAL_FROZEN]] to i64
; CHECK-BE-32-NEXT:    [[TMP2:%.*]] = ptrtoint ptr [[TMP1]] to i64
; CHECK-BE-32-NEXT:    [[TMP3:%.*]] = sub i64 [[TMP2]], 0
...
; CHECK-BE-32-NEXT:    [[TMP5:%.*]] = bitcast i16 [[INTERMEDIATE_VAL_FROZEN_BITS_POSITIONED_PART_EXTRACTED]] to <2 x i8>
; CHECK-BE-32-NEXT:    call void @use.v2i8(<2 x i8> [[TMP5]])
; CHECK-BE-32-NEXT:    [[TMP6:%.*]] = getelementptr i16, ptr [[TMP1]], i64 [[BYTEOFF1:%.*]]
; CHECK-BE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN:%.*]] = freeze <8 x i8> [[INIT]]
; CHECK-BE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS:%.*]] = bitcast <8 x i8> [[INTERMEDIATE_VAL1_FROZEN]] to i64
; CHECK-BE-32-NEXT:    [[TMP7:%.*]] = ptrtoint ptr [[TMP6]] to i64
; CHECK-BE-32-NEXT:    [[TMP8:%.*]] = sub i64 [[TMP7]], 0
; CHECK-BE-32-NEXT:    [[TMP9:%.*]] = sdiv exact i64 [[TMP8]], ptrtoint (ptr getelementptr (i8, ptr null, i32 1) to i64)
; CHECK-BE-32-NEXT:    [[DOTNUMBITS2:%.*]] = mul i64 [[TMP9]], 8
; CHECK-BE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED:%.*]] = shl i64 [[INTERMEDIATE_VAL1_FROZEN_BITS]], [[DOTNUMBITS2]]
; CHECK-BE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART:%.*]] = lshr i64 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED]], 48
; CHECK-BE-32-NEXT:    [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART_EXTRACTED:%.*]] = trunc i64 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART]] to i16
; CHECK-BE-32-NEXT:    [[TMP10:%.*]] = bitcast i16 [[INTERMEDIATE_VAL1_FROZEN_BITS_POSITIONED_PART_EXTRACTED]] to <2 x i8>
; CHECK-BE-32-NEXT:    call void @use.v2i8(<2 x i8> [[TMP10]])
; CHECK-BE-32-NEXT:    ret void
;
  %intermediate = alloca [8 x i8], align 64
  %init = load <8 x i8>, ptr %src, align 1
