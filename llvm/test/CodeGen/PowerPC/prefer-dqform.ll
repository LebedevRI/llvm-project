...
; CHECK-P9-NEXT:    clrldi r10, r3, 32
; CHECK-P9-NEXT:    extsw r11, r4
; CHECK-P9-NEXT:    rldic r3, r3, 3, 29
...
; CHECK-P9-NEXT:    extswsli r7, r5, 3
; CHECK-P9-NEXT:    subfic r4, r5, 2
; CHECK-P9-NEXT:    sub r5, r6, r7
; CHECK-P9-NEXT:    sub r7, r11, r10
; CHECK-P9-NEXT:    sldi r4, r4, 3
; CHECK-P9-NEXT:    rldicl r7, r7, 60, 4
; CHECK-P9-NEXT:    add r4, r6, r4
; CHECK-P9-NEXT:    addi r6, r9, 16
; CHECK-P9-NEXT:    addi r7, r7, 1
; CHECK-P9-NEXT:    mtctr r7
; CHECK-P9-NEXT:    .p2align 4
; CHECK-P9-NEXT:  .LBB0_2: # %_loop_2_do_
; CHECK-P9-NEXT:    #
; CHECK-P9-NEXT:    lxvx vs1, r9, r3
; CHECK-P9-NEXT:    lxvx vs2, r6, r3
; CHECK-P9-NEXT:    lxvx vs3, r5, r3
; CHECK-P9-NEXT:    lxvx vs4, r4, r3
; CHECK-P9-NEXT:    xvmaddadp vs1, vs3, vs1
; CHECK-P9-NEXT:    xvmaddadp vs2, vs4, vs0
; CHECK-P9-NEXT:    stxvx vs1, r9, r3
; CHECK-P9-NEXT:    stxvx vs2, r6, r3
...
; CHECK-P10-NEXT:    clrldi r10, r3, 32
; CHECK-P10-NEXT:    extsw r11, r4
; CHECK-P10-NEXT:    rldic r3, r3, 3, 29
; CHECK-P10-NEXT:    add r5, r8, r5
; CHECK-P10-NEXT:    addi r3, r3, -8
; CHECK-P10-NEXT:    addi r8, r5, -8
; CHECK-P10-NEXT:    lwa r5, 0(r7)
; CHECK-P10-NEXT:    lxvdsx vs0, 0, r8
; CHECK-P10-NEXT:    extswsli r7, r5, 3
; CHECK-P10-NEXT:    subfic r4, r5, 2
; CHECK-P10-NEXT:    sub r5, r6, r7
; CHECK-P10-NEXT:    sub r7, r11, r10
; CHECK-P10-NEXT:    sldi r4, r4, 3
; CHECK-P10-NEXT:    add r4, r6, r4
; CHECK-P10-NEXT:    addi r6, r9, 16
; CHECK-P10-NEXT:    rldicl r7, r7, 60, 4
; CHECK-P10-NEXT:    addi r7, r7, 1
; CHECK-P10-NEXT:    mtctr r7
; CHECK-P10-NEXT:    .p2align 4
; CHECK-P10-NEXT:  .LBB0_2: # %_loop_2_do_
; CHECK-P10-NEXT:    #
; CHECK-P10-NEXT:    lxvx vs1, r9, r3
; CHECK-P10-NEXT:    lxvx vs2, r6, r3
; CHECK-P10-NEXT:    lxvx vs3, r5, r3
; CHECK-P10-NEXT:    xvmaddadp vs1, vs3, vs1
; CHECK-P10-NEXT:    lxvx vs4, r4, r3
; CHECK-P10-NEXT:    xvmaddadp vs2, vs4, vs0
; CHECK-P10-NEXT:    stxvx vs1, r9, r3
; CHECK-P10-NEXT:    stxvx vs2, r6, r3
