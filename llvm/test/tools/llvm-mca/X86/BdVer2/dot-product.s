...
# CHECK-NEXT:  -      -      -      -      -      -      -      -     5.52   5.48    -      -      -      -     2.00   1.00    -      -      -      -      -      -      -

# CHECK:      Resource pressure by instruction:
# CHECK-NEXT: [0.0]  [0.1]  [1]    [2]    [3]    [4]    [5]    [6]    [7.0]  [7.1]  [8.0]  [8.1]  [9]    [10]   [11]   [12]   [13]   [14]   [15]   [16.0] [16.1] [17]   [18]   Instructions:
# CHECK-NEXT:  -      -      -      -      -      -      -      -     0.50   0.50    -      -      -      -      -     1.00    -      -      -      -      -      -      -     vmulps	%xmm0, %xmm1, %xmm2
# CHECK-NEXT:  -      -      -      -      -      -      -      -     2.13   2.87    -      -      -      -     1.00    -      -      -      -      -      -      -      -     vhaddps	%xmm2, %xmm2, %xmm3
# CHECK-NEXT:  -      -      -      -      -      -      -      -     2.88   2.12    -      -      -      -     1.00    -      -      -      -      -      -      -      -     vhaddps	%xmm3, %xmm3, %xmm4
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     3     1.0    1.0    11.3      vmulps	%xmm0, %xmm1, %xmm2
# CHECK-NEXT: 1.     3     4.0    0.0    4.0       vhaddps	%xmm2, %xmm2, %xmm3
# CHECK-NEXT: 2.     3     13.0   0.0    0.0       vhaddps	%xmm3, %xmm3, %xmm4
# CHECK-NEXT:        3     6.0    0.3    5.1       <total>
