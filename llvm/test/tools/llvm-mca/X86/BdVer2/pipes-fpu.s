...
# CHECK-NEXT:  -      -      -      -      -      -      -     1.00   15.09  14.91  1.10   1.90   9.00   1.00   6.00   5.00    -      -      -      -      -      -      -

# CHECK:      Resource pressure by instruction:
# CHECK-NEXT: [0.0]  [0.1]  [1]    [2]    [3]    [4]    [5]    [6]    [7.0]  [7.1]  [8.0]  [8.1]  [9]    [10]   [11]   [12]   [13]   [14]   [15]   [16.0] [16.1] [17]   [18]   Instructions:
# CHECK-NEXT:  -      -      -      -      -      -      -      -      -      -     0.90   0.10   2.00    -     2.00   1.00    -      -      -      -      -      -      -     vpmulld	%xmm0, %xmm1, %xmm2
# CHECK-NEXT:  -      -      -      -      -      -      -      -      -      -     0.20   1.80    -      -      -     1.00    -      -      -      -      -      -      -     vpand	%xmm0, %xmm1, %xmm2
...
# CHECK-NEXT:  -      -      -      -      -      -      -      -     4.59   4.41    -      -      -      -      -     1.00    -      -      -      -      -      -      -     vsqrtps	%xmm0, %xmm2
...
# CHECK-NEXT: [0,3]     .   DeeeeeeeeeeeeER .    .    .    . .   vpclmulqdq	$0, %xmm0, %xmm1, %xmm2
# CHECK-NEXT: [0,4]     .    DeeeeeE------R .    .    .    . .   vaddps	%xmm0, %xmm1, %xmm2
# CHECK-NEXT: [0,5]     .    DeeeeeeeeeE--R .    .    .    . .   vsqrtps	%xmm0, %xmm2
# CHECK-NEXT: [0,6]     .    .DeeeeeE-----R .    .    .    . .   vaddps	%ymm0, %ymm1, %ymm2
# CHECK-NEXT: [0,7]     .    .D==eeeeeeeeeER.    .    .    . .   vsqrtps	%ymm0, %ymm2
...
# CHECK-NEXT: [1,4]     .    .    .D===eeeeeE------R  .    . .   vaddps	%xmm0, %xmm1, %xmm2
...
# CHECK:            [0]    [1]    [2]    [3]
# CHECK-NEXT: 0.     2     3.0    3.0    0.5       vpmulld	%xmm0, %xmm1, %xmm2
# CHECK-NEXT: 1.     2     1.5    1.5    5.0       vpand	%xmm0, %xmm1, %xmm2
# CHECK-NEXT: 2.     2     2.0    2.0    3.0       vcvttps2dq	%xmm0, %xmm2
# CHECK-NEXT: 3.     2     2.5    2.5    0.0       vpclmulqdq	$0, %xmm0, %xmm1, %xmm2
# CHECK-NEXT: 4.     2     2.5    2.5    6.0       vaddps	%xmm0, %xmm1, %xmm2
# CHECK-NEXT: 5.     2     3.0    3.0    1.5       vsqrtps	%xmm0, %xmm2
# CHECK-NEXT: 6.     2     7.0    7.0    2.5       vaddps	%ymm0, %ymm1, %ymm2
# CHECK-NEXT: 7.     2     9.0    9.0    0.0       vsqrtps	%ymm0, %ymm2
# CHECK-NEXT:        2     3.8    3.8    2.3       <total>
